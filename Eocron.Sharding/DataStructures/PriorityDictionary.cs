...
namespace Eocron.Sharding.DataStructures
{
        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        public PriorityDictionary(IEqualityComparer<TKey> keyComparer = null, IComparer<TPriority> priorityComparer = null)
        {
        ...
        {
            if (!_keyToPriorityIndex.TryGetValue(key, out var oldPriority))
            {
                return false;
            }
        ...
        public bool TryDequeue(out TKey key, out TElement element)
        {
            ...
            {
                _priorityToSetIndex.Remove(priorityPair.Key);
            }
        ...
        private void RemoveByOldPriority(TKey key, TPriority oldPriority, out TElement element)
        {
            ...
            if (set.Count == 0)
            {
                _priorityToSetIndex.Remove(oldPriority);
            }
        }
